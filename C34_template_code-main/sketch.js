...
function setup() 
{
  ...
  button.position(540,80);
  button.size(50,50);
  button.mouseClicked(drop);

   //btn 2
   button2 = createImg('cut_btn.png');
   button2.position(260,90);
   button2.size(50,50);
   button2.mouseClicked(drop2);
 
   rope = new Rope(7,{x:540,y:80});
   rope2 = new Rope(7,{x:260,y:90});
  ...
  star = createSprite(200,250,100,100)
  star.addImage(star_img);
  star.scale = 0.02

  
  star2 = createSprite(450,50,100,100)
  star2.addImage(star_img);
  star2.scale = 0.02

  blower = createImg("baloon2.png");
  blower.position(350,350)
  blower.size(120,120)
  blower.mouseClicked(airBlow)
  
  blower2 = createImg("balloon.png");
  blower2.position(50,200)
